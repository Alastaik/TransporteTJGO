...
CREATE TABLE IF NOT EXISTS checklists (
  ...
  entrada_assinatura_vistoriador TEXT,
  ...
  saida_assinatura_vistoriador TEXT,
  ...
  emp_entrada_assinatura_vistoriador TEXT,
  ...
  emp_saida_assinatura_vistoriador TEXT,
...
CREATE TABLE IF NOT EXISTS auditoria (
  ...
  acao            VARCHAR(50) NOT NULL, -- 'criou', 'editou_entrada', 'editou_saida', 'concluiu', 'deletou'
  detalhes        TEXT,
  criado_em       TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
CREATE INDEX IF NOT EXISTS idx_auditoria_checklist ON auditoria(checklist_id);
...
CREATE INDEX IF NOT EXISTS idx_fotos_checklist ON fotos_checklist (checklist_id);
