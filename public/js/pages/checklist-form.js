...
const ChecklistFormPage = {
    ...
    <div class="app-layout">
      ...
      <main class="main-content">
        <div class="container">
          ...
          <!-- Assinatura -->
          <div class="card">
            <h2><span class="material-symbols-rounded section-icon">draw</span> ASSINATURA</h2>
            <div style="text-align:center;margin-bottom:10px;">
              <label class="signature-label">Clique no quadro para assinar:</label>
              <div class="signature-container">
                <img id="signaturePreview" class="signature-preview" onclick="openSign()" alt="Toque para assinar">
                <div class="signature-placeholder" onclick="openSign()">
  ...
  renderVeiculoSection(suffix) {
    ...
    return `
    <div class="card ${isEmp ? 'emprestimo-card' : ''}">
      <h2 class="${isEmp ? 'emprestimo-title' : ''}"><span class="material-symbols-rounded section-icon">directions_car</span> DADOS DO VEÍCULO</h2>
  ...
  renderChecklistSection(suffix) {
    ...
    return `
    <div class="card ${isEmp ? 'emprestimo-card' : ''}">
      <h2 class="${isEmp ? 'emprestimo-title' : ''}"><span class="material-symbols-rounded section-icon">check_circle</span> CHECKLIST</h2>
  ...
  renderFotosSection(containerId, labelsOrCount, formId) {
    ...
    const title = isAvarias ? 'FOTOS DE AVARIAS' : 'FOTOS GERAIS';
    const icon = isAvarias ? 'warning' : 'photo_camera';
    const isEmp = formId === 'emprestimo';
    return `
    <div class="card ${isEmp ? 'emprestimo-card' : ''}">
      <h2 class="${isEmp ? 'emprestimo-title' : ''}"><span class="material-symbols-rounded section-icon">${icon}</span> ${title}</h2>
